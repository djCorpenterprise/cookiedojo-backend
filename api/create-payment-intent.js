...
const CONTACT_EMAIL = 'cookiedojojax@gmail.com';
...
<div style="max-width:560px;margin:40px auto;background:#FFFDF7;border-radius:6px;overflow:hidden;border:1px solid #EDD9A3;">
  <div style="background:#1C1209;padding:32px 40px;text-align:center;">
    <div style="font-size:28px;font-weight:700;color:#FBF4E6;">Cookie <span style="color:#D4A843;">Dojo</span></div>
    <div style="font-size:12px;letter-spacing:.18em;text-transform:uppercase;color:rgba(251,244,230,.4);margin-top:6px;">Jacksonville, FL</div>
  </div>
  <div style="background:#C8721A;padding:16px 40px;text-align:center;">
    <div style="font-size:14px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:#FFFDF7;">✓ Order Confirmed</div>
  </div>
  <div style="padding:40px;">
    ...
    <p style="font-size:15px;color:#3D2B18;font-weight:300;line-height:1.7;margin:0 0 32px;">
      Your Cookie Dojo order is confirmed! We'll reach out shortly to coordinate delivery or pickup. Everything is made fresh — please allow 48 hours from your order time.
    </p>
    <div style="background:#F5E8C8;border:1px solid #EDD9A3;border-radius:4px;padding:14px 20px;margin-bottom:28px;text-align:center;">
      ...
      <div style="font-size:20px;font-weight:700;color:#1C1209;">${orderId}</div>
    </div>
    <div style="margin-bottom:28px;">
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px;">
        <thead><tr style="background:#FBF4E6;">
          <th style="padding:8px 12px;text-align:left;font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:#3D2B18;">Item</th>
          <th style="padding:8px 12px;text-align:center;font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:#3D2B18;">Qty</th>
          <th style="padding:8px 12px;text-align:right;font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:#3D2B18;">Price</th>
        </tr></thead>
    ...
    ${address ? `<div style="margin-bottom:20px;">
      ...
      <div style="font-size:14px;color:#3D2B18;">${address}</div>
    </div>` : ''}
    ${notes ? `<div style="margin-bottom:20px;">
      <div style="font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:#C8721A;margin-bottom:8px;">Your Notes</div>
      <div style="font-size:14px;color:#3D2B18;font-style:italic;">"${notes}"</div>
    </div>` : ''}
    <hr style="border:none;border-top:1px solid #EDD9A3;margin:28px 0;">
    <p style="font-size:13px;color:#6B3E1F;line-height:1.7;margin:0;">
      Questions? Reply to this email or reach us at <a href="mailto:${CONTACT_EMAIL}" style="color:#C8721A;">${CONTACT_EMAIL}</a>. We can't wait for you to enjoy your order! 🍪
    </p>
  </div>
  <div style="background:#FBF4E6;padding:20px 40px;text-align:center;border-top:1px solid #EDD9A3;">
    <div style="font-size:11px;color:#6B3E1F;">Cookie Dojo · Jacksonville, FL · cookiedojo.com</div>
  </div>
</div>
</body></html>`;
}
...
<div style="max-width:560px;margin:40px auto;background:#FFFDF7;border-radius:6px;overflow:hidden;">
  <div style="background:#C8721A;padding:20px 32px;">
    <div style="font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#FFFDF7;">🛎 New Cookie Dojo Order</div>
  ...
  <div style="padding:32px;">
    ...
    <div style="margin-bottom:24px;">
      <div style="font-size:10px;letter-spacing:.2em;text-transform:uppercase;color:#C8721A;margin-bottom:10px;">Items Ordered</div>
    ...
    ${address ? `<div style="margin-bottom:16px;">
    ...
    <div style="margin-top:24px;padding:14px;background:#F5E8C8;border-radius:4px;text-align:center;font-size:12px;color:#6B3E1F;">
      Payment confirmed via Stripe · Reply to ${email} to reach the customer
    </div>
  </div>
</div>
</body></html>`;
